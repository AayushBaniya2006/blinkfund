...
CREATE TABLE "campaigns" (
	...
	"description" text,
	"image_url" text,
	"goal_lamports" numeric(20, 0) NOT NULL,
	"raised_lamports" numeric(20, 0) DEFAULT '0' NOT NULL,
	"donation_count" numeric(10, 0) DEFAULT '0' NOT NULL,
...
CREATE TABLE "donations" (
	...
	"platform_fee_lamports" numeric(20, 0) NOT NULL,
	"creator_lamports" numeric(20, 0) NOT NULL,
	"tx_signature" text,
	"status" "donation_status" DEFAULT 'pending' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"confirmed_at" timestamp,
	CONSTRAINT "donations_tx_signature_unique" UNIQUE("tx_signature")
);
--> statement-breakpoint
...
CREATE TABLE "wallet_verifications" (
	...
	CONSTRAINT "wallet_verifications_wallet_address_unique" UNIQUE("wallet_address")
);
--> statement-breakpoint
...
CREATE INDEX "campaigns_creator_wallet_idx" ON "campaigns" USING btree ("creator_wallet");--> statement-breakpoint
...
CREATE INDEX "donations_donor_wallet_idx" ON "donations" USING btree ("donor_wallet");--> statement-breakpoint
CREATE INDEX "donations_tx_signature_idx" ON "donations" USING btree ("tx_signature");--> statement-breakpoint
CREATE INDEX "donations_status_idx" ON "donations" USING btree ("status");--> statement-breakpoint
CREATE INDEX "wallet_verifications_wallet_address_idx" ON "wallet_verifications" USING btree ("wallet_address");